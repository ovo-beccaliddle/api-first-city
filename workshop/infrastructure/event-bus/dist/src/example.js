...
async function exampleUsage() {
    ...
    const eventBus = new index_1.EventBus({
    ...
    await eventBus.subscriber.subscribe(serviceName, 'sample.resources.created', async (message, data) => {
        // Process the message
    ...
    await eventBus.subscriber.subscribe(serviceName, 'sample.resources.updated', async (message, data) => {
